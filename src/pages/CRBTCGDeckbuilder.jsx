...
import { CardStateProviderCookieRun } from "../context/useCardStateCookieRun";
import CRBTCGBuilderBar from "../components/CRBTCGPageComponent/CRBTCGBuilderBar";
import CRBTCGRightBar from "../components/CRBTCGPageComponent/CRBTCGRightBar";
import CRBTCGBuilderButtonList from "../components/CRBTCGPageComponent/CRBTCGBuilderButton";

const CRBTCGDeckbuilder = () => {
          ...
          <Box sx={{ display: "flex", flexDirection: { xs: "column", sm: "column", md: "row" }, flex: 1, height: '100%' }}>
            ...
            <Hidden only={['md', 'lg', 'xl']}>
              <Box bgcolor={"#202023"} sx={{ overflowY: 'auto', overflowX: "hidden", height: '100%', width: '100%', }} className="hide-scrollbar">
                <CRBTCGBuilderBar changeClick={changeClick} setChangeClick={setChangeClick} style={{ width: "100%", top: '64px', position: "fixed", }} />
                <CRBTCGRightBar setChangeClick={setChangeClick} />
            ...
            <Hidden mdUp> {/* This will hide the content for screens md (medium) and up */}
              <Drawer
                ...
                <Box sx={{
                  ...
                  <CRBTCGBuilderButtonList filters={filters} isButtonClicked={isButtonClicked} setIsButtonClicked={setIsButtonClicked} setChangeClick={setChangeClick} />
                </Box>
              </Drawer>
            ...
            <Hidden only={['xs', 'sm']}>
              <Box flex={6} bgcolor={"#262626"} sx={{ overflowY: 'auto',overflowX:'hidden', height: '100%' }} className="hide-scrollbar">
                <CRBTCGBuilderBar changeClick={changeClick} setChangeClick={setChangeClick}/>
                <CRBTCGRightBar setChangeClick={setChangeClick} />
                <br></br>
                <br></br>
                <br></br>
...
export default CRBTCGDeckbuilder