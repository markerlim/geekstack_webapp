                ...
                {animeFilter === "" && (
                    <>
                        <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "center", flexWrap: "wrap", gap: 1 }}>
                            <Button variant={animeFilter === "Code Geass" ? "contained" : "outlined"} sx={{ backgroundColor: "#b67ab4", color: "#ffffff" }} onClick={() => setAnimeFilter("Code Geass")}>Code Geass</Button>
                            <Button variant={animeFilter === "Jujutsu No Kaisen" ? "contained" : "outlined"} sx={{ backgroundColor: "#b67ab4", color: "#ffffff" }} onClick={() => setAnimeFilter("Jujutsu No Kaisen")}>Jujutsu No Kaisen</Button>
                            <Button variant={animeFilter === "Hunter X Hunter" ? "contained" : "outlined"} sx={{ backgroundColor: "#b67ab4", color: "#ffffff" }} onClick={() => setAnimeFilter("Hunter X Hunter")}>Hunter X Hunter</Button>
                            <Button variant={animeFilter === "Idolmaster Shiny Colors" ? "contained" : "outlined"} sx={{ backgroundColor: "#b67ab4", color: "#ffffff" }} onClick={() => setAnimeFilter("Idolmaster Shiny Colors")}>Idolmaster Shiny Colors</Button>
                            <Button variant={animeFilter === "Demon Slayer" ? "contained" : "outlined"} sx={{ backgroundColor: "#b67ab4", color: "#ffffff" }} onClick={() => setAnimeFilter("Demon Slayer")}>Demon Slayer</Button>
                            <Button variant={animeFilter === "Tales of Arise" ? "contained" : "outlined"} sx={{ backgroundColor: "#b67ab4", color: "#ffffff" }} onClick={() => setAnimeFilter("Tales of Arise")}>Tales of Arise</Button>
                            <Button variant={animeFilter === "That Time I Got Reincarnated as a Slime" ? "contained" : "outlined"} sx={{ backgroundColor: "#b67ab4", color: "#ffffff" }} onClick={() => setAnimeFilter("That Time I Got Reincarnated as a Slime")}>That Time I Got Reincarnated as a Slime</Button>
                        </Box>
                    </>
                )}
                {animeFilter !== "" && (
