...
const AcardTSK = (props) => {
    ...
    const [animeFilter, setAnimeFilter] = useState("That Time I Got Reincarnated as a Slime");
    ...
    const resetFilters = () => {
        setBoosterFilter("");
        setColorFilter("");
        setAnimeFilter("That Time I Got Reincarnated as a Slime");
