...
const AcardBLC = (props) => {
    ...
    const [animeFilter, setAnimeFilter] = useState("Bleach: Thousand-Year Blood War");
    ...
    const resetFilters = () => {
        ...
        setAltFormIndex({});
        setAnimeFilter("Bleach: Thousand-Year Blood War");
                ...
                <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                    <FormControl sx={{ margin: 1 }}>
                        ...
                        >
                            ...
                            <MenuItem value="UA09BT">UA08BT</MenuItem>
                            <MenuItem value="UA09ST">UA08ST</MenuItem>
                        </Select>
                    </FormControl>
                    <FormControl sx={{ margin: 1 }}>
                        <Select
