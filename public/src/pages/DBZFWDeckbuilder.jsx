          ...
          <Box sx={{ display: "flex", flexDirection: { xs: "column", sm: "column", md: "row" }, flex: 1, height: '100%' }}>
            ...
            <Hidden only={['md', 'lg', 'xl']}>
              <Box bgcolor={"#202023"} sx={{ overflowY: 'auto', overflowX: "hidden", height: '100%', width: '100%', }} className="hide-scrollbar">
                <DBZFWBuilderBar changeClick={changeClick} setChangeClick={setChangeClick} style={{ width: "100%", top: '64px', position: "fixed", }} />
                <DBZFWRightBar setChangeClick={setChangeClick} />
            ...
            <Hidden mdUp> {/* This will hide the content for screens md (medium) and up */}
              <Drawer
                ...
                <Box sx={{
                  ...
                  <DBZFWBuilderButtonList filters={filters} isButtonClicked={isButtonClicked} setIsButtonClicked={setIsButtonClicked} setChangeClick={setChangeClick} />
                </Box>
              </Drawer>
            ...
            <Hidden only={['xs', 'sm']}>
              <Box flex={6} bgcolor={"#262626"} sx={{ overflowY: 'auto',overflowX:'hidden', height: '100%' }} className="hide-scrollbar">
                <DBZFWBuilderBar changeClick={changeClick} setChangeClick={setChangeClick}/>
                <DBZFWRightBar setChangeClick={setChangeClick} />
                <br></br>
                <br></br>
                <br></br>
...
export default DBZFWDeckbuilder